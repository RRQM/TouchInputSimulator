...
namespace TouchInputSimulator
{
    ...
    /// </summary>
    public partial interface IKeyboardSimulator
    {
        /// <summary>
    ...
    public partial interface IKeyboardSimulator
    {
        ...
        /// </summary>
        /// <param name="keyCode">The <see cref="VirtualKeyCode"/> for the key.</param>
        Task<IKeyboardSimulator> KeyDownAsync(VirtualKeyCode keyCode);

        /// <summary>
        /// Simulates the key press gesture for the specified key.
        /// </summary>
        /// <param name="keyCode">The <see cref="VirtualKeyCode"/> for the key.</param>
        Task<IKeyboardSimulator> KeyPressAsync(VirtualKeyCode keyCode);

        /// <summary>
        /// Simulates a key press for each of the specified key codes in the order they are specified.
        /// </summary>
        /// <param name="keyCodes"></param>
        Task<IKeyboardSimulator> KeyPressAsync(params VirtualKeyCode[] keyCodes);

        /// <summary>
        /// Simulates the key up gesture for the specified key.
        /// </summary>
        /// <param name="keyCode">The <see cref="VirtualKeyCode"/> for the key.</param>
        Task<IKeyboardSimulator> KeyUpAsync(VirtualKeyCode keyCode);
        ...
        /// <param name="modifierKeyCodes">The list of <see cref="VirtualKeyCode"/>s for the modifier keys.</param>
        /// <param name="keyCodes">The list of <see cref="VirtualKeyCode"/>s for the keys to simulate.</param>
        Task<IKeyboardSimulator> ModifiedKeyStrokeAsync(IEnumerable<VirtualKeyCode> modifierKeyCodes, IEnumerable<VirtualKeyCode> keyCodes);
        ...
        /// <param name="modifierKeyCodes">The list of <see cref="VirtualKeyCode"/>s for the modifier keys.</param>
        /// <param name="keyCode">The <see cref="VirtualKeyCode"/> for the key.</param>
        Task<IKeyboardSimulator> ModifiedKeyStrokeAsync(IEnumerable<VirtualKeyCode> modifierKeyCodes, VirtualKeyCode keyCode);
        ...
        /// <param name="modifierKey">The <see cref="VirtualKeyCode"/> for the modifier key.</param>
        /// <param name="keyCodes">The list of <see cref="VirtualKeyCode"/>s for the keys to simulate.</param>
        Task<IKeyboardSimulator> ModifiedKeyStrokeAsync(VirtualKeyCode modifierKey, IEnumerable<VirtualKeyCode> keyCodes);
        ...
        /// <param name="modifierKeyCode">The <see cref="VirtualKeyCode"/> for the  modifier key.</param>
        /// <param name="keyCode">The <see cref="VirtualKeyCode"/> for the key.</param>
        Task<IKeyboardSimulator> ModifiedKeyStrokeAsync(VirtualKeyCode modifierKeyCode, VirtualKeyCode keyCode);

        /// <summary>
        /// Simulates uninterrupted text entry via the keyboard.
        /// </summary>
        /// <param name="text">The text to be simulated.</param>
        Task<IKeyboardSimulator> TextEntryAsync(string text);

        /// <summary>
        /// Simulates a single character text entry via the keyboard.
        /// </summary>
        /// <param name="character">The unicode character to be simulated.</param>
        Task<IKeyboardSimulator> TextEntryAsync(char character);

        /// <summary>
        /// Sleeps the executing thread to create a pause between simulated inputs.
        /// </summary>
        /// <param name="millsecondsTimeout">The number of milliseconds to wait.</param>
        Task<IKeyboardSimulator> SleepAsync(int millsecondsTimeout);

        /// <summary>
        /// Sleeps the executing thread to create a pause between simulated inputs.
        /// </summary>
        /// <param name="timeout">The time to wait.</param>
        Task<IKeyboardSimulator> SleepAsync(TimeSpan timeout);
    }
#endif
